...
namespace IIS.DokumentooborotKR
{
    ...
    public class ТЧСоздДок : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧСоздДокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧСоздДокE", typeof(IIS.DokumentooborotKR.ТЧСоздДок));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧСоздДок : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.DokumentooborotKR.DetailArrayOfТЧСоздДок members)

        // *** End programmer edit section *** (IIS.DokumentooborotKR.DetailArrayOfТЧСоздДок members)
        ...
        /// </summary>
        public DetailArrayOfТЧСоздДок(IIS.DokumentooborotKR.ХрДок fХрДок) : 
                base(typeof(ТЧСоздДок), ((ICSSoft.STORMNET.DataObject)(fХрДок)))
        {
        }
        
        public IIS.DokumentooborotKR.ТЧСоздДок this[int index]
        {
            get
            {
                return ((IIS.DokumentooborotKR.ТЧСоздДок)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.DokumentooborotKR.ТЧСоздДок dataobject)
        {
