...
namespace IIS.DokumentooborotKR
{
    ...
    public class ТЧПрава : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.DokumentooborotKR.ПраваПол fПраваПол;
        ...
        public virtual IIS.DokumentooborotKR.ПраваПол ПраваПол
        {
            get
            {
                ...
                IIS.DokumentooborotKR.ПраваПол result = this.fПраваПол;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.DokumentooborotKR.АвПользователи.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПраваE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПраваE", typeof(IIS.DokumentooborotKR.ТЧПрава));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПрава : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.DokumentooborotKR.DetailArrayOfТЧПрава members)

        // *** End programmer edit section *** (IIS.DokumentooborotKR.DetailArrayOfТЧПрава members)
        ...
        /// </summary>
        public DetailArrayOfТЧПрава(IIS.DokumentooborotKR.АвПользователи fАвПользователи) : 
                base(typeof(ТЧПрава), ((ICSSoft.STORMNET.DataObject)(fАвПользователи)))
        {
        }
        
        public IIS.DokumentooborotKR.ТЧПрава this[int index]
        {
            get
            {
                return ((IIS.DokumentooborotKR.ТЧПрава)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.DokumentooborotKR.ТЧПрава dataobject)
        {
