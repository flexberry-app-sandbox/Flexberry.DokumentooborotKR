...
moduleForAcceptance('[AGAT] Acceptance | i i s dokumentooborot k r ав пользователи l');

test('testing i-i-s-dokumentooborot-k-r-ав-пользователи-l', function(assert) {
