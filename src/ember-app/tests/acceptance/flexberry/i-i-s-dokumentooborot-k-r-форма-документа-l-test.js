...
moduleForAcceptance('[AGAT] Acceptance | i i s dokumentooborot k r форма документа l');

test('testing i-i-s-dokumentooborot-k-r-форма-документа-l', function(assert) {
