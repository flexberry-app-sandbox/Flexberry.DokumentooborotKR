...
moduleForModel('i-i-s-dokumentooborot-k-r-форма-документа', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-форма-документа', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-форма-документа',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
