...
moduleForModel('i-i-s-dokumentooborot-k-r-сотрудники', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
