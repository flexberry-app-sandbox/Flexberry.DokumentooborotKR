...
moduleForModel('i-i-s-dokumentooborot-k-r-вход-в-систему', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-вход-в-систему', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-вход-в-систему',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
