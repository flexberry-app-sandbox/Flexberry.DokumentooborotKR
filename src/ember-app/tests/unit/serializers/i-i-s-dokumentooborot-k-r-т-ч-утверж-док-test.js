...
moduleForModel('i-i-s-dokumentooborot-k-r-т-ч-утверж-док', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-т-ч-утверж-док', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-т-ч-утверж-док',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
