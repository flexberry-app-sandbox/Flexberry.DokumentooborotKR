...
moduleForModel('i-i-s-dokumentooborot-k-r-т-ч-пользователь', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-т-ч-пользователь', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-т-ч-пользователь',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
