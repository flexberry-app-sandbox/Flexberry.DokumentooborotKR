...
moduleForModel('i-i-s-dokumentooborot-k-r-т-ч-созд-док', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-т-ч-созд-док', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-т-ч-созд-док',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
