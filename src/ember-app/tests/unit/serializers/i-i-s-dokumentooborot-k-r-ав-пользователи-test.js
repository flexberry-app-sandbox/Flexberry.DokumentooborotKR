...
moduleForModel('i-i-s-dokumentooborot-k-r-ав-пользователи', 'Unit | Serializer | i-i-s-dokumentooborot-k-r-ав-пользователи', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-k-r-ав-пользователи',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
